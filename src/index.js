...
(function(factory) {
  ...
  /**
   * Cluttery_Maxwin_game_client_API.<br>
   * The <code>index</code> module provides access to constructors for all the classes which comprise the public API.
   * <p>
   * An AMD (recommended!) or CommonJS application will generally do something equivalent to the following:
   * <pre>
   * var MaxwinServiceApi = require('index'); // See note below*.
   * var xxxSvc = new MaxwinServiceApi.XxxApi(); // Allocate the API class we're going to use.
   * var yyyModel = new MaxwinServiceApi.Yyy(); // Construct a model instance.
   ...
   * <pre>
   * var xxxSvc = new MaxwinServiceApi.XxxApi(); // Allocate the API class we're going to use.
   * var yyy = new MaxwinServiceApi.Yyy(); // Construct a model instance.
   * yyyModel.someProperty = 'someValue';
   * ...
   * var zzz = xxxSvc.doSomething(yyyModel); // Invoke the service.
   * ...
